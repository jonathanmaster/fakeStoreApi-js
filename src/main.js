...
const desktopMenuCategory = document.querySelector(".desktop-menuCategory");
...
menuCategory.addEventListener("click", () => {
  ...
  desktopMenuCategory.classList.toggle("inactive");
});
...
const getCategoriesProducts = async () => {
  ...
  data.forEach((category) => {
    const previewCategoryContainer = document.querySelector(
